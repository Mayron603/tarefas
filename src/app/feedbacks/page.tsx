...
export default async function FeedbacksPage() {
  ...
  const weeklyPerformanceData = [
      { name: 'Concluídas no Prazo', value: tasksDoneOnTime, fill: 'hsl(var(--chart-2))' },
      { name: 'Concluídas com Atraso', value: tasksDoneLate, fill: 'hsl(var(--chart-5))' },
  ];
                         ...
                         <ChartContainer config={{}} className="min-h-[250px] w-full">
                            <ResponsiveContainer width="100%" height={250}>
                               <BarChart data={weeklyPerformanceData} layout="vertical" margin={{ left: 30 }}>
                                    ...
                                    <Bar dataKey="value" name="Tarefas" background={{ fill: 'hsl(var(--muted))' }} />
                                </BarChart>
                            </ResponsiveContainer>
                        </ChartContainer>
                    </CardContent>
